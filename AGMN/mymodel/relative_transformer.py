...
class RelativeSinusoidalPositionalEmbedding(RelativeEmbedding):  #相对正弦位置嵌入
...
class RelativeMultiHeadAttn(nn.Module):
    ...
    def forward(self, x, mask):
        ...
        # r_w_bias 和 pos_embed 的点积 D_，表示每个头对每个位置的偏置程度
        #计算 q 和 pos_embed 的点积 B_，表示每个查询和每个位置的偏移程度
